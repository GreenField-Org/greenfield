 ...
 */
return array(
	'title'      => __( 'Page layout with two columns', 'greenfield' ),
	...
	'content'    => '<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var(--wp--custom--spacing--large, 8rem)","bottom":"var(--wp--custom--spacing--large, 8rem)"}}},"layout":{"inherit":true}} -->
					...
					<h1 class="alignwide" style="font-size:clamp(4rem, 15vw, 12.5rem);font-weight:200;line-height:1">' . wp_kses_post( __( '<em>Goldfinch </em><br><em>&amp; Sparrow</em>', 'greenfield' ) ) . '</h1>
					<!-- /wp:heading -->
					...
					<p>' . esc_html__( 'WELCOME', 'greenfield' ) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:column -->
					...
					<p>' . esc_html__( 'POSTS', 'greenfield' ) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:column --></div>
					<!-- /wp:columns -->
